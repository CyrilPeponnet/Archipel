...
class TNXMPPServerController (TNArchipelPlugin):
   ...
   ## Utils
    ...
    ## TNXMPPServerController xmpp implementation
...
## TNXMPPServerController xmlrpc implementation
    ...
    ###  TNXMPPServerControllerBase xmlrpc implementation for SRG
