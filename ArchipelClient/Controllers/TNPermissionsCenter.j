...
- (id)init
{
    if (self = [super init])
    {
        ...
        [_imageViewControlDisabledPrototype setImage:[[CPImage alloc] initWithContentsOfFile:[[CPBundle mainBundle] pathForResource:@"IconsButtons/denied.png"] size:CGSizeMake(16.0, 16.0)]];
    }
